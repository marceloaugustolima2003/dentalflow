...
export const PATCH_NOTES_CONTENT = `
    <div class="space-y-4">
        <div class="border-l-4 border-accent-green pl-3">
            <span class="inline-block bg-accent-green text-white text-xs font-bold px-2 py-1 rounded mb-1">[NOVO] Cobranças com PIX Automático</span>
        ...
        <div class="border-l-4 border-accent-green pl-3">
            <span class="inline-block bg-accent-green text-white text-xs font-bold px-2 py-1 rounded mb-1">[NOVO] Nova Central de Exportação</span>
        ...
        <div class="border-l-4 border-accent-purple pl-3">
            <span class="inline-block bg-accent-purple text-white text-xs font-bold px-2 py-1 rounded mb-1">[MELHORIA] PDFs com Design Profissional</span>
        ...
        <div class="border-l-4 border-red-500 pl-3">
            <span class="inline-block bg-red-500 text-white text-xs font-bold px-2 py-1 rounded mb-1">[CORREÇÃO] Ajuste de Margens nas Tabelas</span>
        ...
        <div class="border-l-4 border-accent-purple pl-3">
            <span class="inline-block bg-accent-purple text-white text-xs font-bold px-2 py-1 rounded mb-1">[MELHORIA] Interface Mais Limpa</span>
