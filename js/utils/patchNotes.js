...
export const PATCH_NOTES_CONTENT = `
    <div class="space-y-4">
        <div class="border-l-4 border-accent-green pl-3">
            ...
            <p class="text-sm text-gemini-secondary">Selecione trabalhos específicos via checkbox para gerar a nota do dentista. O PDF gerado já inclui o QR Code do PIX com o valor exato da cobrança!</p>
        </div>
